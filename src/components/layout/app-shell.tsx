...
const icons = {
  ...
  creditCard: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>
  ),
};
...
const SETTINGS_ITEMS = [
  ...
  { href: '/settings/billing', label: 'Billing', icon: icons.creditCard },
