...
export function ReviewShell({ sourceTitle, initialClips, initialTexts }: ReviewShellProps) {
  ...
  return (
    <div className="flex h-full flex-col">
      {/* Header */}
      <div className="flex shrink-0 items-center gap-4 border-b border-border bg-white px-6 py-3">
        <a href="/" className="text-[var(--text-tertiary)] hover:text-muted-foreground">
          ...
          <button
            ...
            className={cn(
              ...
              tab === 'clips'
                ...
                : 'text-[var(--text-tertiary)] hover:text-muted-foreground',
            )}
          >
            Clips ({clips.length})
          </button>
      ...
      <div className="flex flex-1 overflow-hidden">
        {tab === 'clips' ? (
          <>
            ...
            <div className="w-[340px] shrink-0 overflow-auto border-r border-border bg-white">
              <ClipList
                clips={clips}
