    ...
    return (
      <div className="flex h-full items-center justify-center p-8 text-center">
        <div className="max-w-xs">
          ...
          <p className="mb-1 text-sm font-semibold text-foreground">No clips generated</p>
      ...
      {clips.map((clip) => {
        ...
        return (
          ...
          >
            ...
            <div className="relative flex h-[90px] w-[68px] shrink-0 items-center justify-center overflow-hidden rounded-lg border border-border bg-gradient-to-b from-[#e8e6e1] to-[var(--border-hover)]">
              <svg className="text-[var(--text-tertiary)] opacity-40" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="mb-1 flex items-center gap-1.5">
                ...
                <span className="text-[11px] font-semibold capitalize text-[var(--text-tertiary)]">
                  {clip.status}
                </span>
              ...
              {/* Title */}
              <div className="mb-1.5 line-clamp-2 text-[13px] font-semibold leading-snug text-foreground">
                {clip.title}
              </div>
                ...
                {clip.platforms.length > 0 && (
                  <div className="flex gap-1">
                    {clip.platforms.map((p) => (
                      <PlatformIcon key={p} platform={p} size={14} className="text-[var(--text-tertiary)]" />
                    ))}
                  </div>
                )}
              </div>
